...
#pragma once
    ...
    #error "The contents of ttcvector_wx.h are available only with C++17 or later."
#endif
...
/// string handling. It can be used in most places where std::vector<std::string> is used.
